<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productRegistretion.aspx.cs" Inherits="phase2assignment10.productRegistretion" %>
        ...
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    <td>Product Image</td>
                    <td>
                                     <div class="col-md-4"><asp:Image runat="server" ID="Image3" ImageUrl="~/camera.jpg" Width="500" Height="500" CssClass="img-fluid" /></div>
                        </td>
